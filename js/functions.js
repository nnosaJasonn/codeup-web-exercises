...
function calculateTip(percentage, total) {
    ...
    var totalCost = tip + +total;
    alert('your bill was $' + total + ' and you want to tip ' + percentage + '% which is ' + tip + '. That brings your total to $' + totalCost)
}

var bill = prompt('How much was the bill?');
var percentTip = prompt('what percentage would you like to tip?');

calculateTip(percentTip,bill);
...
function applyDiscount(price, discount) {
    ...
    if (discount < 1 && discount > 0) {
        ...
        alert('Please enter your discount in the form of a decimal')
    }
}

var price = prompt('What was the price?');
